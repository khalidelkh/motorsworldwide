...
if( !class_exists( 'Indusri_Woo_Others' ) ) {

    class Indusri_Woo_Others {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'indusri_woo_others_settings', $this->settings );
...
if( !function_exists('indusri_woo_others') ) {
	function indusri_woo_others() {
		return Indusri_Woo_Others::instance();
	}
}
