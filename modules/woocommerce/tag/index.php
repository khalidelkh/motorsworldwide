...
if( !class_exists( 'Indusri_Woo_Listing_Tag' ) ) {

    class Indusri_Woo_Listing_Tag {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'indusri_woo_tag_page_default_settings', $this->settings );
...
if( !function_exists('indusri_woo_listing_tag') ) {
	function indusri_woo_listing_tag() {
		return Indusri_Woo_Listing_Tag::instance();
	}
}

indusri_woo_listing_tag();