                ...
                <div class="center-content">
                    <div class="error-box square">
                        <div class="error-box-inner">
                            <h3><?php esc_html_e("Oops!", 'indusri'); ?></h3>
                            <h2>404</h2>
                            <h4><?php esc_html_e("Page Not Found", 'indusri'); ?></h4>
                        </div>
                    </div>
                    <div class="wdt-hr-invisible-xsmall"></div>
                    <p><?php esc_html_e("It seems you've ventured too far.", 'indusri'); ?></p>
                    <div class="wdt-hr-invisible-xsmall"></div>
                    <a class="wdt-button filled small" target="_self" href="<?php echo esc_url(home_url('/'));?>"><?php esc_html_e("Back to Home",'indusri');?></a>
                </div>
            </div>
        </div>
    </div><?php
