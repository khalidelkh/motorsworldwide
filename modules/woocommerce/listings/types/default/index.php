...
if( !class_exists( 'Indusri_Woo_Listing_Type_Default' ) ) {

    class Indusri_Woo_Listing_Type_Default {
        ...
        function __construct() {
            ...
            /* Initialize Type */
                ...
                $this->type_name = esc_html__('Default', 'indusri');
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( indusri_is_file_in_theme( __FILE__ ) ) {
                    return INDUSRI_MODULE_DIR . '/woocommerce/listings/types/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( indusri_is_file_in_theme( __FILE__ ) ) {
                    return INDUSRI_MODULE_URI . '/woocommerce/listings/types/';
                } else {
        ...
        */
            function render_backend() {
                ...
                /* Custom Product Templates - Options */
                    add_filter( 'indusri_woo_default_product_templates', array( $this, 'woo_default_product_templates'), 10, 1 );
        ...
        */
            function woo_default_product_templates( $templates ) {
                ...
                $default_template = array (
                    'id'              => 'indusri-woo-product-style-template-'.$this->type_slug,
                    'type'            => 'group',
                    'indusri_default_type' => true,
                    'title'           => sprintf( esc_html__( 'Product Templates - %1$s', 'indusri' ), $this->type_name ),
                    'button_title'    => esc_html__('Add New', 'indusri'),
                    'accordion_title' => esc_html__('Add New Template', 'indusri'),
                    'fields'          => indusri_woo_listing_fw_template_settings()->woo_get_options_params( $type_options, 'default' ),
        ...
        */
            function set_type_options() {
                ...
                $type_options['product-custom-class'] = 'wdt-custom-product-type-1';
                ...
                $type_options['product-thumb-iconsgroup-position'] = 'product-thumb-iconsgroup-position-horizontal horizontal-position-bottom';
                ...
                $type_options['product-content-buttonelement-style'] = 'product-content-buttonelement-style-skinbgfill-square';
        ...
        */
            function render_frontend() {
                ...
                if( $non_archive_listing ) {
                    ...
                    /* Types CSS */
                        add_filter( 'indusri_woo_non_archive_css', array( $this, 'woo_listings_css_load'), 10, 1 );

                } else {

                    /* Types CSS */
                        add_filter( 'indusri_woo_archive_css', array( $this, 'woo_listings_css_load'), 10, 1 );
            ...
            function for_non_archive_listing() {
                ...
                /* Assets Load */
                    ...
                    // CSS
                        ...
                        wp_register_style( 'indusri-woo-non-archive', '', array (), INDUSRI_THEME_VERSION, 'all' );
                        wp_enqueue_style( 'indusri-woo-non-archive' );
                        ...
                        $css = apply_filters( 'indusri_woo_non_archive_css', $css );

                        if( !empty($css) ) {
                            wp_add_inline_style( 'indusri-woo-non-archive', $css );
                        }

                    // JS

                        wp_register_script( 'indusri-woo-non-archive', '', array ('jquery'), false, true );
                        wp_enqueue_script( 'indusri-woo-non-archive' );
                        ...
                        $js = apply_filters( 'indusri_woo_non_archive_js', $js );

                        if( !empty($js) ) {
                            wp_add_inline_script( 'indusri-woo-non-archive', $js );
                        }
...
if( !function_exists('indusri_woo_listing_type_default') ) {
	function indusri_woo_listing_type_default() {
		return Indusri_Woo_Listing_Type_Default::instance();
	}
}

indusri_woo_listing_type_default();