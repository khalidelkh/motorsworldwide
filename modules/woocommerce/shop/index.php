...
if( !class_exists( 'Indusri_Woo_Listing_Shop' ) ) {

    class Indusri_Woo_Listing_Shop {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'indusri_woo_shop_page_default_settings', $this->settings );
...
if( !function_exists('indusri_woo_listing_shop') ) {
	function indusri_woo_listing_shop() {
		return Indusri_Woo_Listing_Shop::instance();
	}
}

indusri_woo_listing_shop();