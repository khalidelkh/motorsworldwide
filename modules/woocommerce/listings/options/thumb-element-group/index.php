...
if( !class_exists( 'Indusri_Woo_Listing_Option_Thumb_Element_Group' ) ) {

    class Indusri_Woo_Listing_Option_Thumb_Element_Group extends Indusri_Woo_Listing_Option_Core {
        ...
        function render_backend() {
            ...
            add_filter( 'indusri_woo_custom_product_template_thumb_options', array( $this, 'woo_custom_product_template_thumb_options'), 55, 1 );
        }
...
if( !function_exists('indusri_woo_listing_option_thumb_element_group') ) {
	function indusri_woo_listing_option_thumb_element_group() {
		return Indusri_Woo_Listing_Option_Thumb_Element_Group::instance();
	}
}

indusri_woo_listing_option_thumb_element_group();