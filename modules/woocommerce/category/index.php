...
if( !class_exists( 'Indusri_Woo_Listing_Category' ) ) {

    class Indusri_Woo_Listing_Category {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( indusri_is_file_in_theme( __FILE__ ) ) {
                    return INDUSRI_MODULE_DIR . '/woocommerce/category/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( indusri_is_file_in_theme( __FILE__ ) ) {
                    return INDUSRI_MODULE_URI . '/woocommerce/category/';
                } else {
        ...
        function woo_template_redirect() {
            ...
            if( is_product_category() ) {
                ...
                /* Define Sorter Settings */
                    add_filter( 'indusri_woo_sorter_settings', array( $this, 'woo_sorter_settings' ) );
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'indusri_woo_category_page_default_settings', $this->settings );
        ...
        */
            function woo_load_listing() {
                ...
                if( $this->settings['product_style_template'] == 'predefined' ) {
                    $type_class_instance = 'indusri_woo_listing_type_'.$this->settings['product_style_custom_template']; // Type Class Instance
                } else if( $this->settings['product_style_template'] == 'custom' ) {
                    $type_class_instance = 'indusri_woo_listing_type_custom'; // Type Class Instance
                }
                ...
                if ( function_exists( $type_class_instance ) ) {
                    ...
                    if( is_array ( $type_options ) && !empty ( $type_options ) ) {
                        foreach ( $type_options as $type_option_key => $type_option ) {
                            ...
                            $option_class_instance = 'indusri_woo_listing_option_'.$type_option_key;  // Option Class Instance
...
if( !function_exists('indusri_woo_listing_category') ) {
	function indusri_woo_listing_category() {
		return Indusri_Woo_Listing_Category::instance();
	}
}

indusri_woo_listing_category();