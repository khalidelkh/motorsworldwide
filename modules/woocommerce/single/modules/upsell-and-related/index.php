...
if( !class_exists( 'Indusri_Shop_Single_Module_Upsell_Related' ) ) {

    class Indusri_Shop_Single_Module_Upsell_Related {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( indusri_is_file_in_theme( __FILE__ ) ) {
                    return INDUSRI_MODULE_DIR . '/woocommerce/single/modules/upsell-and-related/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( indusri_is_file_in_theme( __FILE__ ) ) {
                    return INDUSRI_MODULE_URI . '/woocommerce/single/modules/upsell-and-related/';
                } else {
        ...
        */
            function woo_load_listing( $product_style_template, $product_style_custom_template ) {
                ...
                if( $product_style_template == 'predefined' ) {
                    $type_class_instance = 'indusri_woo_listing_type_'.$product_style_custom_template; // Type Class Instance
...
if( !function_exists('indusri_shop_single_module_upsell_related') ) {
	function indusri_shop_single_module_upsell_related() {
		return Indusri_Shop_Single_Module_Upsell_Related::instance();
	}
}

indusri_shop_single_module_upsell_related();